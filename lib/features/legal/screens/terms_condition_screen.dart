...
class _TermsConditionScreenState extends State<TermsConditionScreen> {
  ...
  void initState() {
    ...
    ever(controller.termsPage, (page) {
    ...
    // If already loaded
    if (controller.termsPage.value != null && controller.termsPage.value!.description.isNotEmpty) {
      _webController.loadHtmlString(wrapHtmlContent(controller.termsPage.value!.description));
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Obx(() => Text(
          controller.termsPage.value?.pageName.replaceAll('_', ' ').capitalizeFirst ?? "Terms & Conditions",
      ...
      body: Obx(() {
        if (controller.isTermsLoading.value && controller.termsPage.value == null) {
          return const Center(
